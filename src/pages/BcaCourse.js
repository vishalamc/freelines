...
const ContactCard = () => {
  ...
  return (
    <section className="contact-section">
      <h2>BCA Tuition Class</h2>

      <div className="contact-card">
        <div className="course-description" lang="hi">
          यह कोर्स उन विद्यार्थियों के लिए विशेष रूप से तैयार किया गया है जो BCA के सभी विषयों में मजबूत पकड़ बनाना चाहते हैं और अपने विश्वविद्यालय परीक्षाओं, प्रोजेक्ट्स व इंटरनल असेसमेंट में उत्कृष्ट प्रदर्शन करना चाहते हैं।
          <br /><br />
