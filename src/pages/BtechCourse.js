...
const ContactCard = () => {
  ...
  return (
    <section className="contact-section">
      <h2>BTech(Computer Science) Tuition Class</h2>

      <div className="contact-card">
        <div className="course-description" lang="hi">
          हमारे B.Tech ट्यूशन क्लासेस का उद्देश्य इंजीनियरिंग विद्यार्थियों को उनके विषयों की गहराई से समझ दिलाना और उन्हें विश्वविद्यालय परीक्षाओं, प्रोजेक्ट्स, तथा प्लेसमेंट तैयारी में उत्कृष्ट प्रदर्शन करने में सहायता करना है।
          <br /><br />
