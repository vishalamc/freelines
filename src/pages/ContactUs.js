    ...
    <section className="contact-section">
      ...
      <div className="contact-card">
        ...
        <div className="socials">
          <a href="https://github.com/vishalamc" target="_blank" rel="noreferrer">
            <img src="/Icons/github.svg" alt="GitHub" />
          </a>
          <a href="https://linkedin.com/in/kumar-vishal-a6b65b1a" target="_blank" rel="noreferrer">
            <img src="/Icons/linkedin.svg" alt="LinkedIn" />
          </a>
          <a href="mailto:futurelineskasba@gmail.com">
      ...
      <div className="contact-buttons">
        <button onClick={() => navigate("/myportfolio")}>⬅ My Portfolio</button>
