...
const recordedLecturesData = {
  'C Programming': {
    ...
    videos: [
      { id: 1, videoUrl: 'https://www.youtube.com/embed/f0EWiGaKMKI', title: 'Introduction to Programming Language', duration: '13:08' },
      { id: 2, videoUrl: 'https://www.youtube.com/embed/kw5EwhiEADM', title: 'Variables and Its Types', duration: '28:54' },
  ...
  return (
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        <h1 style={styles.headerTitle}>📹 Video Lectures</h1>
