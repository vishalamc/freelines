...
const Pgdca = () => {
  ...
  return (
    <section className="contact-section">
      <h2>POST GRADUATE DIPLOMA IN COMPUTER APPLICATION</h2>

      <div className="contact-card">
        <ul className="course-list">
          <li>Computer Fundamentals & Operating Systems</li>
          <li>Programming in C & Data Structures</li>
          <li>Database Management System (DBMS) with SQL</li>
          <li>Web Designing using HTML, CSS & JavaScript</li>
          <li>Object Oriented Programming using Java</li>
          <li>Software Engineering & Project Management</li>
          <li>Python Programming with Data Analysis Basics</li>
          <li>Tally ERP with GST</li>
          <li>Practical & Viva (Covering All Technologies)</li>
        </ul>
