    ...
    <section className="contact-section">
      ...
      <div className="contact-card">
        <ul className="course-list">
          ...
          <li>Digital Services (CSC, Forms, Aadhar, PAN, Bill)</li>
          <li>Photoshop & Image Editing</li>
          <li>Graphics Designing (Posters, Cards, Invitations)</li>
          <li>Tally with GST (Basic Accounting)</li>
          <li>Practical Work (Real Use + Viva)</li>
        </ul>
