...
const Ccc = () => {
  ...
  return (
    <section className="contact-section">
      <h2>CERTIFICATE COURSE IN COMPUTER</h2>

      <div className="contact-card">
        <ul className="course-list">
          <li>Computer Fundamentals</li>
          <li>Operating System Basics</li>
          <li>Microsoft Word & Documentation</li>
          <li>Microsoft Excel & Spreadsheet</li>
          <li>Microsoft PowerPoint & Presentation Skills</li>
          <li>Internet & Email Applications</li>
          <li>Introduction to HTML & Web Basics</li>
          <li>Introduction to Tally with GST</li>
          <li>Practical & Viva</li>
        </ul>
